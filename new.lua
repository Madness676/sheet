...
function Library:CreateWindow(windowname,windowinfo)
    ...
    local TabContainer_2 = Instance.new("UIGridLayout")
    ...
    TabContainer_2.CellPadding = UDim.new(0, 8)
    ...
    function PageYep:addPage(pagename,scrollsize,visible,elementspacing)
        ...
        PageLayout.CellPadding = UDim.new(0,elementspacing) or UDim.new(0,6)
        ...
        function PageElements:addDropdown(dropdownname,list,scrollsize,callback)
            ...
            local DropdownOptionContainerLayout = Instance.new("UIGridLayout")
            ...
            DropdownOptionContainerLayout.CellPadding = UDim.new(0, 5)
