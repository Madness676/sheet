...
function Library:CreateWindow(windowname,windowinfo)
    ...
    local Open7 = Instance.new("TextButton")
    local Open8 = Instance.new("ImageLabel")
...
Open7.Position = UDim2.new(0.858712733, 0, 0.0237762257, 0)
Open7.Size = UDim2.new(0, 50, 0, 50)
Open7.Font = Enum.Font.SourceSans
Open7.Text = "Open"
Open7.TextColor3 = Color3.fromRGB(255, 255, 255)
Open7.TextScaled = true
Open7.TextSize = 16.000
Open7.Draggable = true
Open7.TextWrapped = true
...
game.CoreGui:FindFirstChild("fu8rj82n").Enabled = not game.CoreGui:FindFirstChild("fu8rj82n").Enabled
        ...
        do
        if game:GetService("CoreGui"):FindFirstChild("fu8rj82n") then
        end
        end

Open8.Name = "Open8"
Open8.Parent = Open7
Open8.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Open8.BackgroundTransparency = 1.000
Open8.BorderSizePixel = 1
Open8.Position = UDim2.new(0, 0, 0, 0)
Open8.Size = UDim2.new(0, 50, 0, 50)
Open8.Image = "http://www.roblox.com/asset/?id=11842330950"
